  ...
  $.extend($.summernote.plugins, {
    ...
    'highlight': function (context) {
      ...
      this.createDialog = function () {
        ...
        var languages = [
          'csharp', 'js', 'bsh', 'c', 'cc', 'cpp', 'cs', 'csh', 'cyc', 'cv', 'htm', 'html',
          'java', 'm', 'mxml', 'perl', 'pl', 'pm', 'py', 'php', 'rb',
          'sh', 'xhtml', 'xml', 'xsl'
        ];
      ...
      this.createCodeNode = function (code, select) {
        ...
        const codeMarkup = code//.replace(regex, '<').replace(regex2, '>').replace(regex3, '=>')

        //$code.html(code.replace(/</g, "&lt;").replace(/>/g, "&gt;"));
        $code.html(codeMarkup);

...
{
    public class ProductOverViewType : ObjectGraphType<ProductOverViewView>
    {
        public ProductOverViewType()
        {
            Name = "ProductOverViewType";
            Description = "ProductOverViewType Type";
